...
make_target() {
  if [ -f $PROJECT_DIR/$PROJECT/bootloader/dt-blob.dts ]; then
    echo Compiling device tree blob
    dtc -O dtb -o dt-blob.bin $PROJECT_DIR/$PROJECT/bootloader/dt-blob.dts
  fi
}
...
makeinstall_target() {
  mkdir -p $INSTALL/usr/share/bootloader
    ...
    if [ -f $PROJECT_DIR/$PROJECT/bootloader/dt_blob.dts ]; then
